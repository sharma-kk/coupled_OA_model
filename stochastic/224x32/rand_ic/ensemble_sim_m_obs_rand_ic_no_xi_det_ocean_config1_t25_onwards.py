...
#     outfile = VTKFile('../results/ensem_sim_no_xi_det_ocean_mesh_32_particle_'+str(ensemble_comm.rank + 1)+'_config1_t'+str(int(init_time))+'_onwards_rand_ic.pvd', comm = spatial_comm)
