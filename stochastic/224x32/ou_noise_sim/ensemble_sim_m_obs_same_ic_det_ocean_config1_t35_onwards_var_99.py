...
if ensemble_comm.rank%pvd_print == 0: # printing results corresponding to every pvd_print particle
    ...
    outfile = VTKFile('../results/OU_sim_var_'+str(var)+'_mesh_32_particle_'+str(seed_no)+'_det_ocean_config1_t'+str(int(init_time))+'_onwards_same_ic.pvd', comm = spatial_comm)
