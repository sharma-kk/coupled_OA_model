...
<figure>
  ...
  <figcaption>Atmospheric (top two) and oceanic (bottom two) velocity and temperature fields at t = 25 for the deterministic climate model simulation on the 896 x 128 grid.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Atmospheric vorticity (top) and ocean vorticity (bottom) fields at $t=25$ for the deterministic model simulation on the $896\times 128$ grid.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Atmospheric vorticity fields from three independent realizations of the SPDE on the $224 \times 32$ grid at $t = 35$ (top three plots), compared with the deterministic model result (fourth plot) and the coarse-grained high-resolution solution (last plot).</figcaption>
</figure>
